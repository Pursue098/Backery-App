                                        ...
                                        @foreach($ordersData as $order)
                                            ...
                                            @else
                                                <tr>
                                                    ...
                                                    @else
                                                        <td>
                                                            {{ Form::image(url('assets/images/staticImage/productDefaultImage.png'), 'op_old_image', array("class"=>"op_old_image", "style" => "  width: 50px; height: 50px; margin-left:20px; border: 1px solid black;")) }}                                          {{ Form::image(url('assets/images/staticImage/productDefaultImage.png'), 'op_old_image', array("class"=>"op_old_image", "style" => "  width: 50px; height: 50px; margin-left:20px; border: 1px solid black;")) }}
                                                        </td>
                                                    @endif
                                                    <td>
                                                        @if( $order->id)
